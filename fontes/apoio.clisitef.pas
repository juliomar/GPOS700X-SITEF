...
type
  ...
  public
    ...
    function configuraIntSiTefInterativo(P1: String; P2: String; P3: String): Integer; overload;

    function configuraIntSiTefInterativoEx: Integer; overload;
    function configuraIntSiTefInterativoEx(P1: String; P2: String; P3: String; P4: String; P5: String): Integer; overload;
    ...
    function consultaQtdeDescontoSocioTorcedor(P1: String; P2: Integer; P3: String; P4: String): Integer; overload;
    function continuaFuncaoSiTefInterativo: Integer;
    function correspondenteBancarioSiTefInterativo: Integer; overload;
    function correspondenteBancarioSiTefInterativo(P1: String; P2: String; P3: String; P4: String; P5: String): Integer; overload;
    ...
    function efetuaPagamentoSiTefInterativo(P1: Integer; P2: String; P3: String; P4: String; P5: String; P6: String; P7: String): Integer; overload;
    function enviaRecebeSiTefDireto: Integer; overload;
    function enviaRecebeSiTefDireto(P1: SmallInt; P2: SmallInt; P3: SmallInt; P4: TBytes; P5: SmallInt; P6: SmallInt; P7: SmallInt; P8: String;
      P9: String; P10: String; P11: String; P12: SmallInt): Integer; overload;
    function enviaRecebeSitServicos: Integer; overload;
    function enviaRecebeSitServicos(P1: SmallInt; P2: TBytes; P3: SmallInt; P4: SmallInt; P5: SmallInt; P6: String; P7: String; P8: String;
    ...
    function executaEnviaRecebeSiTefDireto(P1: SmallInt; P2: SmallInt; P3: SmallInt; P4: String; P5: String; P6: String; P7: String; P8: SmallInt)
      : Integer; overload;
    function fechaPinPad: Integer;
    function finalizaFuncaoSiTefInterativo: Integer; overload;
    function finalizaFuncaoSiTefInterativo(P1: SmallInt; P2: String; P3: String; P4: String; P5: String): Integer; overload;
    function finalizaTransacaoIdentificadaSiTef: Integer; overload;
    function finalizaTransacaoIdentificadaSiTef(P1: SmallInt; P2: SmallInt; P3: String; P4: String; P5: String; P6: String): Integer; overload;
    function finalizaTransacaoIdentificadaSiTefBonus: Integer; overload;
    function finalizaTransacaoIdentificadaSiTefBonus(P1: SmallInt; P2: String; P3: String; P4: String; P5: String; P6: String; P7: String)
      : Integer; overload;
    function finalizaTransacaoSiTefInterativo: Integer; overload;
    function finalizaTransacaoSiTefInterativo(P1: SmallInt; P2: String; P3: String; P4: String): Integer; overload;
    function finalizaTransacaoSiTefInterativoBonus: Integer; overload;
    function finalizaTransacaoSiTefInterativoBonus(P1: SmallInt; P2: String; P3: String; P4: String; P5: String; P6: String): Integer; overload;
    function finalizaTransacaoSiTefInterativoEx: Integer; overload;
    function finalizaTransacaoSiTefInterativoEx(P1: SmallInt; P2: String; P3: String; P4: String; P5: String): Integer; overload;
    function flashVendasSitef: Integer; overload;
    function flashVendasSitef(P1: String; P2: String; P3: String; P4: String; P5: String): Integer; overload;
    function forneceParametroEnviaRecebeSiTefDireto: Integer; overload;
    function forneceParametroEnviaRecebeSiTefDireto(P1: SmallInt; P2: String; P3: SmallInt; P4: SmallInt): Integer; overload;
    function funcoesGerenciaisSiTefInterativo: Integer; overload;
    function funcoesGerenciaisSiTefInterativo(P1: String; P2: String; P3: String; P4: String): Integer; overload;
    ...
    function gravaDadosCriptografados(P1: String; P2: Integer; P3: TBytes; P4: Integer; P5: String): Integer; overload;
    function informaProdutoCancelamentoVidalink: Integer; overload;
    function informaProdutoCancelamentoVidalink(P1: SmallInt; P2: String; P3: SmallInt): Integer; overload;
    function informaProdutoVendaVidalink: Integer; overload;
    function informaProdutoVendaVidalink(P1: SmallInt; P2: String; P3: SmallInt; P4: String): Integer; overload;
    ...
    function iniciaCancelamentoIdentificadoSiTefInterativo(P1: String; P2: String; P3: String; P4: String; P5: String): Integer; overload;
    function iniciaCancelamentoPagamentoContasSiTefInterativo: Integer; overload;
    function iniciaCancelamentoPagamentoContasSiTefInterativo(P1: String; P2: String; P3: String; P4: String; P5: String): Integer; overload;
    function iniciaConfiguracaoSiTefInterativo: Integer; overload;
    function iniciaConfiguracaoSiTefInterativo(P1: String; P2: String; P3: String): Integer; overload;
    function iniciaFuncaoAASiTefInterativo: Integer; overload;
    function iniciaFuncaoAASiTefInterativo(P1: Integer; P2: String; P3: String; P4: String; P5: String; P6: String; P7: String; P8: String)
      : Integer; overload;
    function iniciaFuncaoSiTefInterativo: Integer; overload;
    function iniciaFuncaoSiTefInterativo(P1: Integer; P2: String; P3: String; P4: String; P5: String; P6: String; P7: String): Integer; overload;
    function iniciaFuncaoSiTefInterativoCancelamentoVidalink: Integer; overload;
    function iniciaFuncaoSiTefInterativoCancelamentoVidalink(P1: SmallInt; P2: SmallInt; P3: String; P4: String; P5: String; P6: String; P7: String;
      P8: String; P9: String; P10: String): Integer; overload;
    function iniciaFuncaoSiTefInterativoConsultaPBM: Integer; overload;
    function iniciaFuncaoSiTefInterativoConsultaPBM(P1: String; P2: String; P3: String; P4: String; P5: String; P6: String; P7: String)
      : Integer; overload;
    function iniciaFuncaoSiTefInterativoConsultaVidalink: Integer; overload;
    function iniciaFuncaoSiTefInterativoConsultaVidalink(P1: String; P2: String; P3: String; P4: String; P5: String; P6: String): Integer; overload;
    function iniciaFuncaoSiTefInterativoVendaVidalink: Integer; overload;
    function iniciaFuncaoSiTefInterativoVendaVidalink(P1: String; P2: SmallInt; P3: String; P4: String; P5: String; P6: String): Integer; overload;
    function interrompeLeCartaoDireto: Integer;
    function leCampoCriptografadoPinPad: Integer; overload;
    function leCampoCriptografadoPinPad(P1: String; P2: String; P3: SmallInt; P4: SmallInt): Integer; overload;
    function leCampoPinPad: Integer; overload;
    function leCampoPinPad(P1: String; P2: SmallInt; P3: SmallInt): Integer; overload;
    ...
    function leSenhaDiretoEx(P1: String; P2: String; P3: SmallInt): Integer; overload;
    ...
    function obtemDadoPinPadDiretoEx(P1: String; P2: String; P3: String): Integer; overload;
    function obtemDadoPinPadEx: Integer; overload;
    function obtemDadoPinPadEx(P1: String; P2: String; P3: String): Integer; overload;
    function obtemDadosCriptografados: Integer; overload;
    function obtemDadosCriptografados(P1: String; P2: Integer; P3: String): Integer; overload;
    ...
    function obtemQuantidadeTransacoesPendentes(P1: String; P2: String): Integer; overload;
    ...
    function registraBonusOffLineSiTef(P1: String; P2: String; P3: String; P4: String; P5: String; P6: String; P7: String): Integer; overload;
    function registraDescontoSocioTorcedor: Integer; overload;
    function registraDescontoSocioTorcedor(P1: String; P2: String; P3: String; P4: String; P5: String; P6: String): Integer; overload;
    function registraDescontoSocioTorcedorSequencial: Integer; overload;
    function registraDescontoSocioTorcedorSequencial(P1: String; P2: String; P3: String; P4: String; P5: String; P6: String; P7: Integer)
      : Integer; overload;
    function registraTefPromocaoSiTef: Integer; overload;
    function registraTefPromocaoSiTef(P1: String; P2: String; P3: String; P4: String; P5: String; P6: String; P7: String): Integer; overload;
...
function configuraIntSiTefInterativoEx: Integer; overload;
// function configuraIntSiTefInterativoEx(P1: String; P2: String; P3: String; P4: String): Integer; overload;
function configuraIntSiTefInterativoEx(P1: String; P2: String; P3: String; P4: String; P5: String): Integer; overload;
...
function enviaRecebeSiTefDireto(P1: SmallInt; P2: SmallInt; P3: SmallInt; P4: TBytes; P5: SmallInt; P6: SmallInt; P7: SmallInt; P8: String;
  P9: String; P10: String; P11: String; P12: SmallInt): Integer; overload;
function enviaRecebeSitServicos: Integer; overload;
function enviaRecebeSitServicos(P1: SmallInt; P2: TBytes; P3: SmallInt; P4: SmallInt; P5: SmallInt; P6: String; P7: String; P8: String; P9: String)
  : Integer; overload;
function escreveMensagemPermanentePinPad: Integer; overload;
function escreveMensagemPermanentePinPad(P1: String): Integer; overload;
function escreveMensagemPinPad: Integer; overload;
...
function iniciaFuncaoSiTefInterativoCancelamentoVidalink(P1: SmallInt; P2: SmallInt; P3: String; P4: String; P5: String; P6: String; P7: String;
  P8: String; P9: String; P10: String): Integer; overload;
function iniciaFuncaoSiTefInterativoConsultaPBM: Integer; overload;
function iniciaFuncaoSiTefInterativoConsultaPBM(P1: String; P2: String; P3: String; P4: String; P5: String; P6: String; P7: String): Integer;
  overload;
function iniciaFuncaoSiTefInterativoConsultaVidalink: Integer; overload;
function iniciaFuncaoSiTefInterativoConsultaVidalink(P1: String; P2: String; P3: String; P4: String; P5: String; P6: String): Integer; overload;
function iniciaFuncaoSiTefInterativoVendaVidalink: Integer; overload;
...
function TCliSiTefIEx.configuraIntSiTefInterativoEx(P1, P2, P3, P4: String; P5: String): Integer;
begin
  result := FCliSiTefIEx.configuraIntSiTefInterativoEx(STJ(P1), STJ(P2), STJ(P3), STJ(P4), STJ(P5));
end;

// function TCliSiTefIEx.configuraIntSiTefInterativoEx(P1, P2, P3, P4: String): Integer;
// begin
// result := FCliSiTefIEx.configuraIntSiTefInterativoEx(STJ(P1), STJ(P2), STJ(P3), STJ(P4));
// end;
...
function TCliSiTefIEx.consultaQtdeDescontoSocioTorcedor(P1: String; P2: Integer; P3, P4: String): Integer;
begin
  result := FCliSiTefIEx.consultaQtdeDescontoSocioTorcedor(STJ(P1), P2, STJ(P3), STJ(P4));
end;
...
function TCliSiTefIEx.correspondenteBancarioSiTefInterativo(P1, P2, P3, P4, P5: String): Integer;
begin
  result := FCliSiTefIEx.correspondenteBancarioSiTefInterativo(STJ(P1), STJ(P2), STJ(P3), STJ(P4), STJ(P5));
end;
...
function TCliSiTefIEx.efetuaPagamentoSiTefInterativo(P1: Integer; P2, P3, P4, P5, P6, P7: String): Integer;
begin
  result := FCliSiTefIEx.efetuaPagamentoSiTefInterativo(P1, STJ(P2), STJ(P3), STJ(P4), STJ(P5), STJ(P6), STJ(P7));
end;
...
function TCliSiTefIEx.enviaRecebeSiTefDireto(P1, P2, P3: SmallInt; P4: TBytes; P5, P6, P7: SmallInt; P8, P9, P10, P11: String; P12: SmallInt)
  : Integer;
begin
  result := FCliSiTefIEx.enviaRecebeSiTefDireto(P1, P2, P3, ByteToJArray(P4), P5, P6, P7, STJ(P8), STJ(P9), STJ(P10), STJ(P11), P12);
end;
...
function TCliSiTefIEx.enviaRecebeSitServicos(P1: SmallInt; P2: TBytes; P3, P4, P5: SmallInt; P6, P7, P8, P9: String): Integer;
begin
  result := FCliSiTefIEx.enviaRecebeSitServicos(P1, ByteToJArray(P2), P3, P4, P5, STJ(P6), STJ(P7), STJ(P8), STJ(P9));
end;
...
function TCliSiTefIEx.executaEnviaRecebeSiTefDireto(P1, P2, P3: SmallInt; P4, P5, P6, P7: String; P8: SmallInt): Integer;
begin
  result := FCliSiTefIEx.executaEnviaRecebeSiTefDireto(P1, P2, P3, STJ(P4), STJ(P5), STJ(P6), STJ(P7), P8);
end;
...
function TCliSiTefIEx.finalizaFuncaoSiTefInterativo(P1: SmallInt; P2, P3, P4, P5: String): Integer;
begin
  result := FCliSiTefIEx.finalizaFuncaoSiTefInterativo(P1, STJ(P2), STJ(P3), STJ(P4), STJ(P5));
end;
...
function TCliSiTefIEx.finalizaTransacaoIdentificadaSiTef(P1, P2: SmallInt; P3, P4, P5, P6: String): Integer;
begin
  result := FCliSiTefIEx.finalizaTransacaoIdentificadaSiTef(P1, P2, STJ(P3), STJ(P4), STJ(P5), STJ(P6));
end;
...
function TCliSiTefIEx.finalizaTransacaoIdentificadaSiTefBonus(P1: SmallInt; P2, P3, P4, P5, P6, P7: String): Integer;
begin
  result := FCliSiTefIEx.finalizaTransacaoIdentificadaSiTefBonus(P1, STJ(P2), STJ(P3), STJ(P4), STJ(P5), STJ(P6), STJ(P7));
end;

function TCliSiTefIEx.finalizaTransacaoSiTefInterativo(P1: SmallInt; P2, P3, P4: String): Integer;
begin
  result := FCliSiTefIEx.finalizaTransacaoSiTefInterativo(P1, STJ(P2), STJ(P3), STJ(P4));
end;
...
function TCliSiTefIEx.finalizaTransacaoSiTefInterativoBonus(P1: SmallInt; P2, P3, P4, P5, P6: String): Integer;
begin
  result := FCliSiTefIEx.finalizaTransacaoSiTefInterativoBonus(P1, STJ(P2), STJ(P3), STJ(P4), STJ(P5), STJ(P6));
end;
...
function TCliSiTefIEx.finalizaTransacaoSiTefInterativoEx(P1: SmallInt; P2, P3, P4, P5: String): Integer;
begin
  result := FCliSiTefIEx.finalizaTransacaoSiTefInterativoEx(P1, STJ(P2), STJ(P3), STJ(P4), STJ(P5));
end;
...
begin
  result := FCliSiTefIEx.flashVendasSitef(STJ(P1), STJ(P2), STJ(P3), STJ(P4), STJ(P5));
end;
...
function TCliSiTefIEx.forneceParametroEnviaRecebeSiTefDireto(P1: SmallInt; P2: String; P3, P4: SmallInt): Integer;
begin
  result := FCliSiTefIEx.forneceParametroEnviaRecebeSiTefDireto(P1, STJ(P2), P3, P4);
end;
...
function TCliSiTefIEx.funcoesGerenciaisSiTefInterativo(P1, P2, P3, P4: String): Integer;
begin
  result := FCliSiTefIEx.funcoesGerenciaisSiTefInterativo(STJ(P1), STJ(P2), STJ(P3), STJ(P4));
end;
...
function TCliSiTefIEx.gravaDadosCriptografados(P1: String; P2: Integer; P3: TBytes; P4: Integer; P5: String): Integer;
begin
  result := FCliSiTefIEx.gravaDadosCriptografados(STJ(P1), P2, ByteToJArray(P3), P4, STJ(P5));
end;
...
function TCliSiTefIEx.informaProdutoCancelamentoVidalink(P1: SmallInt; P2: String; P3: SmallInt): Integer;
begin
  result := FCliSiTefIEx.informaProdutoCancelamentoVidalink(P1, STJ(P2), P3);
end;

function TCliSiTefIEx.informaProdutoVendaVidalink(P1: SmallInt; P2: String; P3: SmallInt; P4: String): Integer;
begin
...
function TCliSiTefIEx.iniciaCancelamentoIdentificadoSiTefInterativo(P1, P2, P3, P4, P5: String): Integer;
begin
  result := FCliSiTefIEx.iniciaCancelamentoIdentificadoSiTefInterativo(STJ(P1), STJ(P2), STJ(P3), STJ(P4), STJ(P5));
end;

function TCliSiTefIEx.iniciaCancelamentoPagamentoContasSiTefInterativo(P1, P2, P3, P4, P5: String): Integer;
begin
  result := FCliSiTefIEx.iniciaCancelamentoPagamentoContasSiTefInterativo(STJ(P1), STJ(P2), STJ(P3), STJ(P4), STJ(P5));
end;
...
function TCliSiTefIEx.iniciaConfiguracaoSiTefInterativo(P1, P2, P3: String): Integer;
begin
  result := FCliSiTefIEx.iniciaConfiguracaoSiTefInterativo(STJ(P1), STJ(P2), STJ(P3));
end;
...
function TCliSiTefIEx.iniciaFuncaoAASiTefInterativo(P1: Integer; P2, P3, P4, P5, P6, P7, P8: String): Integer;
begin
  result := FCliSiTefIEx.iniciaFuncaoAASiTefInterativo(P1, STJ(P2), STJ(P3), STJ(P4), STJ(P5), STJ(P6), STJ(P7), STJ(P8));
end;
...
function TCliSiTefIEx.iniciaFuncaoSiTefInterativo(P1: Integer; P2, P3, P4, P5, P6, P7: String): Integer;
begin
  result := FCliSiTefIEx.iniciaFuncaoSiTefInterativo(P1, STJ(P2), STJ(P3), STJ(P4), STJ(P5), STJ(P6), STJ(P7));
end;

function TCliSiTefIEx.iniciaFuncaoSiTefInterativoCancelamentoVidalink(P1, P2: SmallInt; P3, P4, P5, P6, P7, P8, P9, P10: String): Integer;
begin
  result := FCliSiTefIEx.iniciaFuncaoSiTefInterativoCancelamentoVidalink(P1, P2, STJ(P3), STJ(P4), STJ(P5), STJ(P6), STJ(P7), STJ(P8), STJ(P9),
    STJ(P10));
end;
...
function TCliSiTefIEx.iniciaFuncaoSiTefInterativoConsultaPBM(P1, P2, P3, P4, P5, P6, P7: String): Integer;
begin
  result := FCliSiTefIEx.iniciaFuncaoSiTefInterativoConsultaPBM(STJ(P1), STJ(P2), STJ(P3), STJ(P4), STJ(P5), STJ(P6), STJ(P7));
end;
...
function TCliSiTefIEx.iniciaFuncaoSiTefInterativoConsultaVidalink(P1, P2, P3, P4, P5, P6: String): Integer;
begin
  result := FCliSiTefIEx.iniciaFuncaoSiTefInterativoConsultaVidalink(STJ(P1), STJ(P2), STJ(P3), STJ(P4), STJ(P5), STJ(P6));
end;
...
function TCliSiTefIEx.iniciaFuncaoSiTefInterativoVendaVidalink(P1: String; P2: SmallInt; P3, P4, P5, P6: String): Integer;
begin
  result := FCliSiTefIEx.iniciaFuncaoSiTefInterativoVendaVidalink(STJ(P1), P2, STJ(P3), STJ(P4), STJ(P5), STJ(P6));
end;
...
function TCliSiTefIEx.leCampoCriptografadoPinPad(P1, P2: String; P3, P4: SmallInt): Integer;
begin
...
function TCliSiTefIEx.obtemDadosCriptografados(P1: String; P2: Integer; P3: String): Integer;
begin
...
function TCliSiTefIEx.obtemQuantidadeTransacoesPendentes(P1, P2: String): Integer;
begin
...
function TCliSiTefIEx.registraBonusOffLineSiTef(P1, P2, P3, P4, P5, P6, P7: String): Integer;
begin
  result := FCliSiTefIEx.registraBonusOffLineSiTef(STJ(P1), STJ(P2), STJ(P3), STJ(P4), STJ(P5), STJ(P6), STJ(P7));
end;

function TCliSiTefIEx.registraDescontoSocioTorcedor(P1, P2, P3, P4, P5, P6: String): Integer;
begin
  result := FCliSiTefIEx.registraDescontoSocioTorcedor(STJ(P1), STJ(P2), STJ(P3), STJ(P4), STJ(P5), STJ(P6));
end;
...
function TCliSiTefIEx.registraDescontoSocioTorcedorSequencial(P1, P2, P3, P4, P5, P6: String; P7: Integer): Integer;
begin
  result := FCliSiTefIEx.registraDescontoSocioTorcedorSequencial(STJ(P1), STJ(P2), STJ(P3), STJ(P4), STJ(P5), STJ(P6), P7);
end;
...
function TCliSiTefIEx.registraTefPromocaoSiTef(P1, P2, P3, P4, P5, P6, P7: String): Integer;
begin
  result := FCliSiTefIEx.registraTefPromocaoSiTef(STJ(P1), STJ(P2), STJ(P3), STJ(P4), STJ(P5), STJ(P6), STJ(P7));
end;
...
function TCliSiTefIEx.validaCampoCodigoEmBarras(P1: String; P2: SmallInt): Integer;
begin
...
function configuraIntSiTefInterativo(P1: String; P2: String; P3: String): Integer;
begin
...
// function configuraIntSiTefInterativoEx(P1: String; P2: String; P3: String; P4: String): Integer;
// begin
// result := CliSiTefIEx.configuraIntSiTefInterativoEx(P1, P2, P3, P4);
// end;

function configuraIntSiTefInterativoEx(P1: String; P2: String; P3: String; P4: String; P5: String): Integer;
begin
  result := CliSiTefIEx.configuraIntSiTefInterativoEx(P1, P2, P3, P4, P5);
end;
...
function consultaQtdeDescontoSocioTorcedor(P1: String; P2: Integer; P3: String; P4: String): Integer;
begin
...
function correspondenteBancarioSiTefInterativo(P1: String; P2: String; P3: String; P4: String; P5: String): Integer;
begin
  result := CliSiTefIEx.correspondenteBancarioSiTefInterativo(P1, P2, P3, P4, P5);
end;
...
function efetuaPagamentoSiTefInterativo(P1: Integer; P2: String; P3: String; P4: String; P5: String; P6: String; P7: String): Integer;
begin
  result := CliSiTefIEx.efetuaPagamentoSiTefInterativo(P1, P2, P3, P4, P5, P6, P7);
end;
...
function enviaRecebeSiTefDireto(P1: SmallInt; P2: SmallInt; P3: SmallInt; P4: TBytes; P5: SmallInt; P6: SmallInt; P7: SmallInt; P8: String;
P9: String; P10: String; P11: String; P12: SmallInt): Integer;
begin
  result := CliSiTefIEx.enviaRecebeSiTefDireto(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12);
end;
...
P9: String): Integer;
begin
  result := CliSiTefIEx.enviaRecebeSitServicos(P1, P2, P3, P4, P5, P6, P7, P8, P9);
end;
...
function executaEnviaRecebeSiTefDireto(P1: SmallInt; P2: SmallInt; P3: SmallInt; P4: String; P5: String; P6: String; P7: String;
P8: SmallInt): Integer;
begin
  result := CliSiTefIEx.executaEnviaRecebeSiTefDireto(P1, P2, P3, P4, P5, P6, P7, P8);
end;
...
function finalizaFuncaoSiTefInterativo(P1: SmallInt; P2: String; P3: String; P4: String; P5: String): Integer;
begin
...
function finalizaTransacaoIdentificadaSiTef(P1: SmallInt; P2: SmallInt; P3: String; P4: String; P5: String; P6: String): Integer;
begin
  result := CliSiTefIEx.finalizaTransacaoIdentificadaSiTef(P1, P2, P3, P4, P5, P6);
end;
...
function finalizaTransacaoIdentificadaSiTefBonus(P1: SmallInt; P2: String; P3: String; P4: String; P5: String; P6: String; P7: String): Integer;
begin
  result := CliSiTefIEx.finalizaTransacaoIdentificadaSiTefBonus(P1, P2, P3, P4, P5, P6, P7);
end;
...
function finalizaTransacaoSiTefInterativo(P1: SmallInt; P2: String; P3: String; P4: String): Integer;
begin
...
function finalizaTransacaoSiTefInterativoBonus(P1: SmallInt; P2: String; P3: String; P4: String; P5: String; P6: String): Integer;
begin
  result := CliSiTefIEx.finalizaTransacaoSiTefInterativoBonus(P1, P2, P3, P4, P5, P6);
end;
...
function finalizaTransacaoSiTefInterativoEx(P1: SmallInt; P2: String; P3: String; P4: String; P5: String): Integer;
begin
...
function flashVendasSitef(P1: String; P2: String; P3: String; P4: String; P5: String): Integer;
begin
...
function forneceParametroEnviaRecebeSiTefDireto(P1: SmallInt; P2: String; P3: SmallInt; P4: SmallInt): Integer;
begin
...
function funcoesGerenciaisSiTefInterativo(P1: String; P2: String; P3: String; P4: String): Integer;
begin
...
function gravaDadosCriptografados(P1: String; P2: Integer; P3: TBytes; P4: Integer; P5: String): Integer;
begin
...
function informaProdutoCancelamentoVidalink(P1: SmallInt; P2: String; P3: SmallInt): Integer;
begin
...
function informaProdutoVendaVidalink(P1: SmallInt; P2: String; P3: SmallInt; P4: String): Integer;
begin
...
function iniciaCancelamentoIdentificadoSiTefInterativo(P1: String; P2: String; P3: String; P4: String; P5: String): Integer;
begin
  result := CliSiTefIEx.iniciaCancelamentoIdentificadoSiTefInterativo(P1, P2, P3, P4, P5);
end;
...
function iniciaCancelamentoPagamentoContasSiTefInterativo(P1: String; P2: String; P3: String; P4: String; P5: String): Integer;
begin
  result := CliSiTefIEx.iniciaCancelamentoPagamentoContasSiTefInterativo(P1, P2, P3, P4, P5);
end;
...
function iniciaConfiguracaoSiTefInterativo(P1: String; P2: String; P3: String): Integer;
begin
...
function iniciaFuncaoAASiTefInterativo(P1: Integer; P2: String; P3: String; P4: String; P5: String; P6: String; P7: String; P8: String): Integer;
begin
  result := CliSiTefIEx.iniciaFuncaoAASiTefInterativo(P1, P2, P3, P4, P5, P6, P7, P8);
end;
...
function iniciaFuncaoSiTefInterativo(P1: Integer; P2: String; P3: String; P4: String; P5: String; P6: String; P7: String): Integer;
begin
...
begin
  result := CliSiTefIEx.iniciaFuncaoSiTefInterativoCancelamentoVidalink(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10);
end;
...
function iniciaFuncaoSiTefInterativoConsultaPBM(P1: String; P2: String; P3: String; P4: String; P5: String; P6: String; P7: String): Integer;
begin
  result := CliSiTefIEx.iniciaFuncaoSiTefInterativoConsultaPBM(P1, P2, P3, P4, P5, P6, P7);
end;
...
function iniciaFuncaoSiTefInterativoConsultaVidalink(P1: String; P2: String; P3: String; P4: String; P5: String; P6: String): Integer;
begin
  result := CliSiTefIEx.iniciaFuncaoSiTefInterativoConsultaVidalink(P1, P2, P3, P4, P5, P6);
end;
...
function iniciaFuncaoSiTefInterativoVendaVidalink(P1: String; P2: SmallInt; P3: String; P4: String; P5: String; P6: String): Integer;
begin
  result := CliSiTefIEx.iniciaFuncaoSiTefInterativoVendaVidalink(P1, P2, P3, P4, P5, P6);
end;
...
function leCampoCriptografadoPinPad(P1: String; P2: String; P3: SmallInt; P4: SmallInt): Integer;
begin
...
function registraBonusOffLineSiTef(P1: String; P2: String; P3: String; P4: String; P5: String; P6: String; P7: String): Integer;
begin
...
function registraDescontoSocioTorcedor(P1: String; P2: String; P3: String; P4: String; P5: String; P6: String): Integer;
begin
...
function registraDescontoSocioTorcedorSequencial(P1: String; P2: String; P3: String; P4: String; P5: String; P6: String; P7: Integer): Integer;
begin
  result := CliSiTefIEx.registraDescontoSocioTorcedorSequencial(P1, P2, P3, P4, P5, P6, P7);
end;
...
function registraTefPromocaoSiTef(P1: String; P2: String; P3: String; P4: String; P5: String; P6: String; P7: String): Integer;
begin
