...
type
  ...
  TCliSiTefI = class
    ...
    function enviaRecebeSiTefDireto(P1: SmallInt; P2: SmallInt; P3: SmallInt; P4: Tdados; P5: SmallInt; P6: SmallInt; P7: SmallInt; P8: String;
      P9: String; P10: String; P11: String; P12: SmallInt): Integer; // Deprecated
